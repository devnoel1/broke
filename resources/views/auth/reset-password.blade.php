...
<form class="uk-grid uk-form" action="{{ route('password.update') }}" method="POST">
    ...
    <div class="uk-margin-small uk-width-1-1 uk-inline">
        ...
        <input class="uk-input uk-border-rounded" name="email" value="{{ old('email', $request->email) }}" type="email" placeholder="Email ">
        @error('email')
    ...
    <div class="uk-margin-small uk-width-1-1">
        <button class="uk-button uk-width-1-1 uk-button-primary uk-border-rounded uk-float-left" type="submit" name="submit">   {{ __('Reset Password') }}</button>
    </div>
</form>
@endsection
